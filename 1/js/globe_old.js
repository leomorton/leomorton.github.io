    ...
    function loadModels() {
      ...
      var onLoad = (gltf, position) => {
        ...
        var t1 = scene.getObjectByName("Market_village_hoverarea");
        ...
        if (im==true) {
            renderer.domElement.addEventListener('touchstart', function(event) {
                ...
                mouse.y = -(event.targetTouches[0].pageY / window.innerHeight) * 2 + 1;
                            ...
                            if(viewmarket==true){ca=["Food_stall_hoverarea","Games_stall_hoverarea","Craft_Stall_hoverarea","Cracker_stall_hoverarea"];}
          ...
          $(document).on('click touchstart', function () {
            ...
            if (stage_0==false) {
                ...
                var ic1 = raycaster.intersectObjects(model.children);
                    if (ic1.length > 0) {
                        if(ic1[0].object.name=="Christmas_hoerarea"){
                            console.log("tree");
                            window.parent.postMessage("btnBaubleEntry",'*');}
                        if(ic1[0].object.name=="Pavillion_hoverarea"){window.parent.postMessage("Pavillion_click",'*');}
                        if(ic1[0].object.name=="Pavillion_click"){window.parent.postMessage("Pavillion_click",'*');}
                        if(ic1[0].object.name=="Ice_rink_hoverarea"){window.parent.postMessage("iceRinkBuilding_click",'*');}
                        if(ic1[0].object.name=="Santas_grotto_hoverarea"){window.parent.postMessage("santasGrotto_click",'*');}
                        if(ic1[0].object.name=="Food_stall_hoverarea"){window.parent.postMessage("btnRecipes",'*');}
                        if(ic1[0].object.name=="Games_stall_hoverarea"){window.parent.postMessage("btnIframe_stack",'*');}
                        if(ic1[0].object.name=="Craft_Stall_hoverarea"){window.parent.postMessage("marketStall_Crafts_click",'*');}
                        if(ic1[0].object.name=="Cracker_stall_hoverarea"){window.parent.postMessage("btnJokes",'*');}
                        if(ic1[0].object.name=="Bandstand_hoverarea"){window.parent.postMessage("btnSpotify",'*');}
                        if(ic1[0].object.name=="Post_box_hoverarea"){window.parent.postMessage("postBox_click",'*');}
                    }
    ...
    function lightup(){
        ...
        if (viewmarket==true){outlinePassBasic.selectedObjects=[o5,o6,o7,o8];}
    ...
    function p2flow(){
        ...
        for (var i=0;i<sc2;i++){
            ...
            p2.position.x=Math.random()*50-25;p2.position.y=(250-Math.random()*200);p2.position.z=Math.random()*50-25;
